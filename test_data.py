...
# 讀取 CSV 檔案
df_train = pd.read_csv('C:/Users/ASUS/OneDrive/桌面/文駿/比賽/AI CUP 2025春季賽－桌球智慧球拍資料的精準分析競賽/39_Test_Dataset/test_info.csv')
...
# 設定輸出資料夾
output_folder = 'C:/Users/ASUS/OneDrive/桌面/文駿/比賽/AI CUP 2025春季賽－桌球智慧球拍資料的精準分析競賽/39_Test_Dataset/test_csv/'
os.makedirs(output_folder, exist_ok=True)

# 設定 txt 檔案的路徑
txt_folder = 'C:/Users/ASUS/OneDrive/桌面/文駿/比賽/AI CUP 2025春季賽－桌球智慧球拍資料的精準分析競賽/39_Test_Dataset/test_data/'

# 批量處理 txt 檔案
for i in range(1968, 3412): # 處理 x.txt ~ xxx.txt 1968 ~ 3411
